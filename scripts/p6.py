...
LOCKED_BG  = (
    "https://pub-009ad35726e64a38930ccc6e3aff0a81.r2.dev/"
    "background%20videos/daily_verse_bg.mp4"
)
...
def write_config(slug: str, verse: str, ref: str, apply_line: str,
                 background: str, duration: int, darken: float) -> Path:
...
def main() -> int:
    ...
    ap.add_argument("--background", default=LOCKED_BG,
                    help="override the locked P6 background URL")
    ...
    if args.batch:
        return do_batch(args.background, args.duration, args.darken)
    ...
    cfg = write_config(
        ...
        args.background, args.duration, args.darken,
    )
